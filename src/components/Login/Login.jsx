            ...
            <div className="containers">
                <form className="form_container mt-5">
                    ...
                    <button title="Sign In" type="submit" className="sign-in_btn">
                        <Link to="/home">  <span className="text-white">Log In Here</span></Link>
                    </button>
                    ...
                    <button title="Sign In" type="submit" className="sign-in_ggl">
                        ...
                        <span> <Link to="/affiliatesignup">Affiliate Sign Up </Link></span>
                    </button>
                    <button title="Sign In" type="submit" className="sign-in_ggl">

                        <span><Link to="/advertisersignup">Advertiser Sign Up </Link></span>
                    </button>
